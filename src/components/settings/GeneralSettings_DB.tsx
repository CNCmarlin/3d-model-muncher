...
export function GeneralSettings_DB({
    localConfig,
    setLocalConfig,
    handleSaveConfig,
    categories,
                    ...
                    <div className="pt-4 border-t mt-4">
                        ...
                        <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg border">
                            <div className="space-y-1">
                                ...
                                <LastRunLabel_DB timestamp={localConfig.lastRunTimestamps?.generateThumbnails} />
                            </div>
                        ...
                        <div className="flex flex-col p-3 bg-muted/50 rounded-lg border mt-2 space-y-3">
                            <div className="flex items-center justify-between">
                                <div className="space-y-1">
                                    ...
                                    <LastRunLabel_DB timestamp={localConfig.lastRunTimestamps?.purgeThumbnails} />
                                </div>
                                <Button
                                    variant="outline"
                                    size="sm"
