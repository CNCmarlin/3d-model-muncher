...
export function ModelDetailsDrawer({
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      if (model) {
        // Prefer modelUrl if available, otherwise normalize the filePath
  ...
  }, [isOpen, defaultModelView, model?.id]);
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                <div className="flex-1 min-w-0 grid grid-cols-[1fr_auto] items-center gap-2">
                  ...
                  <div className="shrink-0 flex gap-2">
                    {(currentModel.related_files && currentModel.related_files.length > 0) && (
                      // [FIX] Changed variant to 'default' to match main button
                      <Button onClick={handleDownloadAll} size="sm" variant="default" className="gap-2" title="Download all files (ZIP)">
                ...
                {viewMode === '3d' ? (
                  <div className="relative w-full h-full">
                    ...
                    <ModelViewerErrorBoundary>
                      <ModelViewer3D
                        key={active3DFile} // Force re-mount when file changes
                        modelUrl={active3DFile || normalizeModelPath(currentModel.modelUrl) || undefined}
