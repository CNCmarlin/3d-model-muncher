import { SharedModelScene_DB } from "@/components/models/SharedModelScene_DB";
...
import { Eye, EyeOff, ImagePlus, Palette, RotateCw } from "lucide-react";
...
export const ModelViewer3D_DB = memo(({ modelUrl, modelName = "3D Model", onCapture, customColor: externalCustomColor, onModelLoaded }: ModelViewer3DProps) => {
...
ModelViewer3D_DB.displayName = "ModelViewer3D_DB";