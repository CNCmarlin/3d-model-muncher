import { ModelViewerErrorBoundary } from "@/components/common/ErrorBoundary_DB";
import { ImageWithFallback_DB } from "@/components/common/ImageWithFallback_DB";
import { ModelViewer3D_DB } from "@/components/models/ModelViewer3D_DB";
...
export const ModelPreviewSection_DB = ({
                        ...
                        {isWindowFullscreen ? (
                            ...
                            <div className="w-full flex items-center justify-center">
                                <div className="relative z-10 w-full max-w-[90vw] max-h-[90vh] flex flex-col items-center justify-center">
                                    <div className="relative w-full flex items-center justify-center">
                                        <ImageWithFallback_DB src={allImages[selectedImageIndex]} alt={`${currentModel.name} - Fullscreen`} className="relative max-w-full h-screen object-contain rounded-lg" />
                                        {allImages.length > 1 && (
                                            <>
                            ...
                            <div>
                                <AspectRatio ratio={16 / 10} className="bg-muted relative group rounded-xl overflow-hidden border border-border/40 shadow-inner">
                                    <ImageWithFallback_DB src={allImages[selectedImageIndex]} alt={currentModel.name} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                                        ...
                                        <div className="flex gap-2 items-center h-20 py-1 pl-2">
                                            ...
                                            {allImages.map((image, index) => {
                                                ...
                                                return (
                                                    ...
                                                    `}
                                                    >
                                                        <ImageWithFallback_DB src={image} className="w-full h-full object-cover" />
