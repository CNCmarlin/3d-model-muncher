...
export function BulkEditDialog_DB({
    isOpen,
    onClose,
    models,
    onRefresh,
    ...
    const isDesktop = useMediaQuery_db("(min-width: 768px)");

    // Form State
    const form = useBulkEditForm_db({ models, isOpen, pendingBulkCollectionId, selectedTargetIds: models.map(m => m.id) });
