...
/**
 * Database LayoutSettingsProvider — full independent copy.
 * Shares the React context object with LayoutSettingsContext so hooks work
 * regardless of which provider the ContextRouter mounts.
 * Diverge this implementation freely for DB-specific layout logic.
 */
export function LayoutSettingsProvider_DB({ children }: { children: ReactNode }) {
...
export function useLayoutSettings() {
  ...
  if (!context) throw new Error('useLayoutSettings must be used within a LayoutSettingsProvider_DB');
  return context;
}
