...
export function BufferedInput_DB({ value, onApply, placeholder, description, type = "text", ...props }: BufferedFieldProps<string | number> & { type?: string } & React.ComponentProps<typeof Input>) {
...
export function BufferedTextarea_DB({ value, onApply, placeholder, description, rows = 3 }: BufferedFieldProps<string> & { rows?: number }) {
...
export function BufferedSelect_DB({ value, onApply, options, placeholder, description }: BufferedFieldProps<string> & { options: BufferedSelectOption[] }) {
    const [localValue, setLocalValue] = useState(value || '');
...
export function BufferedSwitch_DB({ value, onApply, label }: BufferedFieldProps<boolean | undefined> & { label: string }) {
